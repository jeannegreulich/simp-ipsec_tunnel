[![License](http://img.shields.io/:license-apache-blue.svg)](http://www.apache.org/licenses/LICENSE-2.0.html) [![Build Status](https://travis-ci.org/simp/pupmod-simp-ipsec_tunnel.svg)](https://travis-ci.org/simp/pupmod-simp-ipsec_tunnel) [![SIMP compatibility](https://img.shields.io/badge/SIMP%20compatibility-4.2.*%2F5.1.*-orange.svg)](https://img.shields.io/badge/SIMP%20compatibility-4.2.*%2F5.1.*-orange.svg)

#### Table of Contents

1. [Overview](#overview)
2. [Module Description - What the module does and why it is useful](#module-description)
3. [Setup - The basics of getting started with ipsec_tunnel](#setup)
    * [What ipsec_tunnel affects](#what-ipsec_tunnel-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with ipsec_tunnel](#beginning-with-ipsec_tunnel)
